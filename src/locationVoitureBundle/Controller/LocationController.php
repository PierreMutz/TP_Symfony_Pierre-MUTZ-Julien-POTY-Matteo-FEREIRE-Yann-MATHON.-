...
class LocationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $locations = $em->getRepository('locationVoitureBundle:Location')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('locationVoitureBundle\Form\LocationType', $location);
    ...
    {
        $deleteForm = $this->createDeleteForm($location);
        $editForm = $this->createForm('locationVoitureBundle\Form\LocationType', $location);
