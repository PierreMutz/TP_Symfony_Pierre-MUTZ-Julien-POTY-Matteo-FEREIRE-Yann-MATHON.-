...
class VehiculeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $vehicules = $em->getRepository('locationVoitureBundle:Vehicule')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('locationVoitureBundle\Form\VehiculeType', $vehicule);
    ...
    {
        $deleteForm = $this->createDeleteForm($vehicule);
        $editForm = $this->createForm('locationVoitureBundle\Form\VehiculeType', $vehicule);
